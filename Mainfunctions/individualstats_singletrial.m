...
function individualstats_singletrial (Config_File)
...
%changing the masking threshold & high-pass filter(Liping added)
matlabbatch{1}.spm.stats.fmri_spec.sess.hpf = 128 % original value is128;
matlabbatch{1}.spm.stats.fmri_spec.mthresh = 0.8 %original value is 0.8;
...
%--------------------------------------------------------------------------
  ...
  for i=1:8
      for j=1:32  
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.name= contrastNames{i,j};
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.coltype.colconds.conweight = 1;
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.coltype.colconds.colcond = j;
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.coltype.colconds.colbf = 1;
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.coltype.colconds.colmod = 1;
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.coltype.colconds.colmodord= 0;
  matlabbatch{3}.spm.stats.con.consess{n}.tconsess.sessions= i;
  n=n+1;
      end
...
% for i=1:8
%      for j=1:32
%     matlabbatch{2}.spm.stats.con.consess{i}.fcon.name{1,j} = contrastNames{i,j};
%     matlabbatch{2}.spm.stats.con.consess{i}.fcon.convec{1,j} = ...
% 	  contrastVecs{i,j};
%     end
% end
