...
paralist.server_path = '/brain/iCAN/data';
 
% Please specify the individualstats server
paralist.stats_path = '/brain/iCAN/home/zhuangliping/RR/individualstats';
...
paralist.stats_folder = 'RR_singletrial/stats_spm8_swcar';
...
%     '15-12-17.1DST';'15-12-17.2DST';'15-12-24.1DST';'15-12-24.2DST';'15-12-31.1DST'};
  ...
  load('/brain/iCAN/home/zhuangliping/RR/RR_scripts/RR_database.mat');
  a=1;
 for i =[1:50]
  paralist.subjectlist{a,1}=DEP_database_1st{i,2};
  a=a+1;
 end
...
%paralist.exp_sesslist    ={'MS_gender'};
% Please specify the task design file (*.m)
%paralist.task_dsgn       = 'taskdesign_singletrial_gender.m';
paralist.task_dsgn = 'taskdesign_singletrial.m'

% Please specify the file holding contrasts
%paralist.contrastmat = [''];  
paralist.contrastmat  = '/brain/iCAN/home/zhuangliping/scripts/spm8_scripts/Mainfunctions/contrasts/contrasts_RR_singletrial.mat';


% Please specify the foler for preprocessed data via standard pipeline
paralist.preprocessed_folder = 'smoothed_spm8';
 %paralist.preprocessed_folder = 'temp_wcar';
...
paralist.template_path    = '/brain/iCAN/home/zhuangliping/scripts/spm8_scripts/BatchTemplates'; %Shaozheng added
 load('/brain/iCAN/home/zhuangliping/scripts/spm8_scripts/Mainfunctions/batch_stats_singletrial.mat');
